...
export default function Contact() {
  return (
    <footer
      className="w-full px-[5%] py-16 md:py-24 border-t-4 border-black-sec"
    >
      <div className="w-full flex-center flex-col gap-8 md:gap-12">
        <h2 className="head_text uppercase blue_gradient_text">
          Get in touch with me
        </h2>
        <p className="body_text max-w-3xl -mt-4 text-center">
          Have a project idea or collaboration in mind? I&#39;d love to hear from you! Feel free to reach out by sending me an email or text through my socials below.
        </p>
        <ul className="flex-center flex-wrap gap-6 md:gap-8">
          <li>
            <a
              title="email"
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24"><path fill="white" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5l-8-5V6l8 5l8-5v2z" /></svg>
            </a>
          </li>
          <li>
            <a
