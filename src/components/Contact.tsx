  ...
  return (
    ...
    >
      <div className="w-full flex-center flex-col gap-8 md:gap-12">
        ...
        <ul className="flex-center flex-wrap gap-4 sm:gap-6 md:gap-8">
          <li className="w-6 md:w-12">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="white" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5l-8-5V6l8 5l8-5v2z" /></svg>
            </a>
          </li>
          <li className="w-6 md:w-12">
            <a
